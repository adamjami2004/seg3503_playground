...
public class DateNextDateOkTest
{
    ...
    public  DateNextDateOkTest(int a, int b, int c, int d, int e, int f)
    {
        this.aa = a;
        this.bb = b;
        this.cc = c;
    ...
    public void testNextDateOK()
    {
        ...
        Date d = new Date(aa,bb,cc);
        Date z = d.nextDate();
        Assert.assertEquals(dd, z.getYear());
        Assert.assertEquals(ee, z.getMonth());
        Assert.assertEquals(ff, z.getDay());
